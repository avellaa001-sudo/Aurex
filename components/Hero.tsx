      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center relative z-10">
        <div className="space-y-8 animate-fadeIn">
          <div className="inline-flex items-center space-x-2 bg-stone-100 text-stone-600 px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest">
            <span>✨ The New Ritual for Tired Knees</span>
          </div>
          
          <h1 className="text-5xl md:text-7xl font-extrabold leading-[1.05] text-brand tracking-tight">
            Elevate Your <br />
            <span className="text-indigo-600 italic">Evening Rest.</span>
          </h1>
          
          <p className="text-lg md:text-xl text-stone-500 max-w-lg leading-relaxed font-medium">
            Designed for those who spend their days in motion. Aurex combines gentle warmth and soothing relaxation to help you decompress at home.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-5 items-start sm:items-center">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-stone-400 text-[10px] font-bold uppercase tracking-widest">Trusted by thousands of customers</span>
            </div>
          </div>
        ...
        <div className="relative">
          ...
          <div className="relative group perspective-1000">
            <div className="bg-stone-200 p-2 rounded-[50px] shadow-2xl transition-transform duration-700 hover:scale-[1.02]">
               <img 
                 src="https://images.unsplash.com/photo-1544126592-807daa2b565b?auto=format&fit=crop&w=1200&q=80" 
                 alt="Aurex Knee Ritual" 
                 className="rounded-[40px] w-full object-cover aspect-square brightness-95"
               />
               <div className="absolute -bottom-6 -left-6 p-8 glass-card rounded-3xl shadow-xl max-w-[280px]">
                 <p className="text-indigo-600 font-black text-2xl mb-1 italic">Soothing</p>
                 <p className="text-stone-600 text-sm font-medium leading-relaxed">Adjustable warmth for those quiet evenings after a long day.</p>
               </div>
            </div>
          </div>
        </div>
